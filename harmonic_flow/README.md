...
** Might need to change the version depending on your cuda version **

    conda create -c conda-forge -n flowsite rdkit python=3.11
    ...
    pip install torch_scatter torch_sparse torch_cluster -f https://data.pyg.org/whl/torch-2.5.1+cu124.html
